...
Login to the open DTN or ascentand clone this repositry in your home area if you have not already done so. 
...
**The donut code** 
This code uses ascii charaters (those on your keyboard) as pixels. 
...
```
The donut.c code is incuded in this repo. To compile the code: 
```
$ gcc -o donut donut.c
```
To run the code:
